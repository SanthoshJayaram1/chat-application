...
import SearchPeopleModal from './../modal/SearchPeopleModal.js'
    ...
    <>
      <div className='bg-white flex items-center justify-between border-b-2 py-1 md:px-12 sticky top-0 px-4 z-[50]'>
        <div className='flex items-center'>
          <img src={`${process.env.PUBLIC_URL}/images/logo.png`} alt='WeChat' width='35' />
          <h1 className='md:block hidden font-logo text-lg ml-4'>WeChat</h1>
        </div>
        {
          selectContact &&
